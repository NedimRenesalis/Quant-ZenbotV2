...
module.exports = {
  ...
  getOptions: function () {
    ...
    this.option("flash_crash.flash_crash_pct", "Percentage decline for flash crash", Number, 2.0);
    this.option("flash_crash.flash_crash_duration", "Max candles for flash crash", Number, 3);
    ...
    this.option("flash_crash.stop_loss_pct", "Stop loss % for flash crash trades", Number, 1.2);
    this.option("flash_crash.profit_target_pct", "Profit target % for flash crash trades", Number, 2.5);
    ...
    this.option("unsteady_decline.lookback_candles", "Number of candles for unsteady decline lookback", Number, 24);
    this.option("unsteady_decline.min_decline_pct", "Min decline % for unsteady pattern", Number, 4.5);
    this.option("unsteady_decline.max_decline_pct", "Max decline % for unsteady pattern", Number, 5.5);
    ...
    this.option("unsteady_decline.ema_short", "Short EMA period for unsteady decline", Number, 6);
    this.option("unsteady_decline.ema_medium", "Medium EMA period for unsteady decline", Number, 10);
    this.option("unsteady_decline.ema_long", "Long EMA period for unsteady decline", Number, 15);
    this.option("unsteady_decline.stop_loss_pct", "Stop loss % for unsteady decline trades", Number, 1.7);
    this.option("unsteady_decline.profit_target_pct", "Profit target % for unsteady decline trades", Number, 2.2);
    ...
    this.option("position_size_pct", "percentage of available capital per trade", Number, 10);
    ...
    this.option("trailing_stop_pct", "trailing stop percentage", Number, 1.0);
  ...
  phenotypes: {
    ...
    "flash_crash.flash_crash_pct": Phenotypes.RangeFloat(1.0, 5.0),
    "flash_crash.consecutive_red_candles": Phenotypes.Range(2, 5),
    "flash_crash.rsi_oversold": Phenotypes.Range(20, 40),
    "flash_crash.stop_loss_pct": Phenotypes.RangeFloat(0.5, 3.0),
    "flash_crash.profit_target_pct": Phenotypes.RangeFloat(1.0, 5.0),
    ...
    "post_stagnation.stop_loss_pct": Phenotypes.RangeFloat(0.5, 3.0),
    "post_stagnation.profit_target_pct": Phenotypes.RangeFloat(1.0, 5.0),

    "unsteady_decline.enabled": Phenotypes.Range(0, 1),
    "unsteady_decline.lookback_candles": Phenotypes.Range(12, 48),
    "unsteady_decline.min_decline_pct": Phenotypes.RangeFloat(3.0, 6.0),
    "unsteady_decline.max_decline_pct": Phenotypes.RangeFloat(4.0, 7.0),
    "unsteady_decline.min_up_candle_ratio": Phenotypes.RangeFloat(0.2, 0.5),
    "unsteady_decline.stop_loss_pct": Phenotypes.RangeFloat(0.5, 3.0),
    "unsteady_decline.profit_target_pct": Phenotypes.RangeFloat(1.0, 5.0),

    // General Risk Phenotypes
    "position_size_pct": Phenotypes.Range(5, 20),
    "trailing_stop_pct": Phenotypes.RangeFloat(0.5, 2.0),
    "trailing_stop_activation_pct": Phenotypes.RangeFloat(0.5, 2.0),
  }
};
